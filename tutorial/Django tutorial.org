...
:END:
#+OPTIONS:  ':t *:t -:t \n:nil ^:nil
#+OPTIONS:  author:nil broken-links:mark d:nil prop:nil toc:2
...
We want to be able to add and remove tags straight in the editor, like in the following video:

#+CAPTION: Tag workflow in the RealWorld article editor
#+ATTR_HTML: :width 600
[[../assets/editor - tags.mp4]]

The thing is, we can't do that in Django only: in order to have actions triggered by the Enter button, we would need to write JavaScript, which we're trying not to do in this tutorial.
...
Make tag field readonly and button disabled based on ~request.path~ in ~templates/article_tag.html~.
*** TODO check whether urls better than buttons with different names         :noexport:
In ~articles/urls.py~:
...
- [ ] [[https://github.com/pallets/jinja/][Jinja templates]]
* Observations                          :noexport:
** TODO MkDocs process
1. export .org to .md
#+begin_src shell
pandoc --from=org --to=commonmark \
       --filter=/home/warehouse/.pandoc/filters/keep_attributes_markdown.py \
       --output=/home/warehouse/Desktop/Projects/Open\ Source/Django\ tutorial/tutorial/docs/index.md \
       /home/warehouse/Desktop/Projects/Open\ Source/Django\ tutorial/tutorial/Django\ tutorial.org
#+end_src
2. split .md file
#+begin_src shell
python ~/.pandoc/filters/split_markdown_by_headings.py
#+end_src
3. modify ~nav~ in mkdocs.yml if necessary
4. copy index.md as readme.md to root
#+begin_src shell
cp /home/warehouse/Desktop/Projects/Open\ Source/Django\ tutorial/tutorial/docs/index.md \
   /home/warehouse/Desktop/Projects/Open\ Source/Django\ tutorial/readme.md
#+end_src
** TODO at end of every section, include link to snapshot of repo at commit
** TODO explain why no REST, or include REST
** TODO make readme.md
- need to set ~docs_dir: '.'~ somehow: [[https://www.mkdocs.org/user-guide/configuration/#docs_dir][Configuration - MkDocs]], [[https://www.mkdocs.org/user-guide/writing-your-docs/#index-pages][Writing Your Docs - MkDocs]]
- [[https://github.com/seleniumbase/SeleniumBase/blob/master/mkdocs.yml][SeleniumBase/mkdocs.yml at master · seleniumbase/SeleniumBase · GitHub]] has this
** TODO Include emojis and stuff, to look more like [[https://github.com/seleniumbase/SeleniumBase/blob/master/README.md][SeleniumBase/README.md]]
** TODO set up [[https://squidfunk.github.io/mkdocs-material/setup/setting-up-site-analytics/#custom-site-analytics][analytics]]
** TODO PostgreSQL
...
** TODO make pandoc filter to convert inline src blocks into [[https://facelessuser.github.io/pymdown-extensions/extensions/inlinehilite/#overview][inline Markdown code]]
- Currently, pandoc just skips inline src blocks completely
